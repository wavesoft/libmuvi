 ...
 */
#ifndef MUVI_INTERPOLATOR_KRIGING_H
#define MUVI_INTERPOLATOR_KRIGING_H
...
/**
 * Kriging Estimator Interpolation
 *
 * Pros : Error estimation
 * Cons : -
 *
 */

class MuviKrigingInterpolator :
	 public MuviInterpolator {
public:

	MuviKrigingInterpolator() : MuviInterpolator() { };
	virtual ~MuviKrigingInterpolator() { };
